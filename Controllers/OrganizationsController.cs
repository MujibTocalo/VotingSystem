...
namespace VotingSystem.Controllers
{
    ...
    public class OrganizationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,name")] Organizations organizations)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,name")] Organizations organizations)
        {
