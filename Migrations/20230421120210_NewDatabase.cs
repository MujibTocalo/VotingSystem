        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
              ...
              values: new object[,]
              {
                    ...
                    { "2", "Voter", "VOTER", Guid.NewGuid().ToString() },
                    { "3", "Comelec", "COMELEC", Guid.NewGuid().ToString() }
              });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comelecs", x => x.id);
                    table.ForeignKey(
                        name: "FK_Comelecs_Organizations_organizationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    yearlevel = table.Column<string>(nullable: true),
                    organizationId = table.Column<int>(nullable: true),
                    candidates = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comelecs_organizationId",
                table: "Comelecs",
                column: "organizationId");
